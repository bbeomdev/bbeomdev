...
- 👨‍💼 (주)뎁스 4학년 2학기 인턴 제조산업 AI연구개발과제 - vision ai 모델 연구자 참여 (24.09 ~ 24.12)
...
- :school: 경남대학교 빅데이터센터 (AI모델링, 데이터분석) ( 2022.08~ 2025.02 )

#### Software 기초
- Python FastAPI를 사용한 모델 비동기 API 구축 ( 2024. (주)뎁스 )
- Python 크몽 프리랜서 개발자 ( 크롤링. 업무 자동화 등 프로그램 개발 외주 ) 경험 ( 27건 판매, 기업 2곳 )
