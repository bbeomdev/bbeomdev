...
#### 경험 요약
- 모두의연구소 아이펠 13기 ( 25.03 ~ 25.09 )
- 👨‍💼 창원 (주)뎁스 인턴 제조산업 AI연구개발과제 - vision ai 모델 연구자 참여 (24.09 ~ 24.12)
- 공군 전문특기병(정보보호 CERT) 경력 - 대구 근무 ( 2020 ~ 2022 ), 공군 내/외부망, NAC/firewall/ids/ips 보안장비 정책, 취약점 수정 및 대응 ( 보안 컨설팅,인프라 영역은 담당하지 않았음 )
- 크몽 프리랜서 : 크롤링, 스크래핑 [<정확하고, 가능한 모든 데이터 웹 크롤링/스크래핑>](http://kmong.com/gig/446023) (23.03 ~ 25.02 , 27건 판매)
- 정부과제 vision ai 모델 담당자로 데이터 구축/학습 TTA 유효성 평가 통과 경험
- :school: 경남대학교 빅데이터센터 근무 경험 (AI모델링, 데이터분석) ( 2022.08~ 2025.02 )

#### Software 기초
- Python FastAPI를 사용한 모델 비동기 API 구축. Event Driven ( 2024. (주)뎁스 - 승강기 로프 모니터링 시스템 )
...
| 연도 | 프로젝트명 | 
| -- | -- |
| 2024 | ICNGC 학회(국내) 포스터 - Poststure Recongnition model based on YOLOv8 for handwashing procedure evaluation ( 손씻기 단계 탐지 연구) |
| 2024 | 철강회사 철 스크랩 가격 예측 모델 - 예측 AI 모델 개발 |
| 2024 | 양방향 수어 통역 시스템(특허보유)- 수어 인식 AI 모델 개발 (Vision) |
| 2023 | 정부과제 - [NIA AI허브 어린이 보호구역 내 등하교 및 시설물 영상 데이터 - AI 모델 개발 (Vision)(모델 학습 담당자)](https://www.aihub.or.kr/aihubdata/data/view.do?currMenu=&topMenu=&aihubDataSe=data&dataSetSn=71796) |
| 2023 | 정부과제 - [NIA AI허브 창원지역 특화산업 고도화 및 디지털 전환 촉진을 위한 용접 AI학습 데이터 구축 - AI 모델 개발 (Vision)](https://www.aihub.or.kr/aihubdata/data/view.do?currMenu=&topMenu=&aihubDataSe=data&dataSetSn=71761) |
| 2023 | [ICNGC 학회(국내) 포스터 - AI Model for Bidrectional Sign Language Translation (수어 인식 연구) ](https://www.earticle.net/ASP/Article/448161?Key=D6AFS3Skf5mDuj41jy1ZCg%3D%3D&ReturnUrl=%2FASP%2FArticles%2F1092%3FKey%3DD6AFS3Skf5mDuj41jy1ZCg%253d%253d%26Issue%3D34186%26page%3D3&Mode=Journal) 
| 2022 | 정부과제 - [NIA AI허브 인공지능 학습용 데이터 구축 사업 참여 - 관광 KVQA 데이터 검수자 ](https://www.aihub.or.kr/aihubdata/data/list.do?searchKeyword=kvqa) |
...
| (온라인 셀링 기업) 이커머스 데이터 수집/연동 자동화 및 엑셀 업무 자동화 프로그램 개발 |
...
# 인적사항
#### :school: 경남대학교 컴퓨터공학부(컴퓨터보안전공) / 빅데이터융합학 복수전공 졸업 <br/>
#### :medal_military: 공군 전문특기병(정보보호병 - CERT) 병장 만기전역
